...
func (x *LogingResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LogingResponse) ProtoMessage() {}

func (x *LogingResponse) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LogingResponse.ProtoReflect.Descriptor instead.
func (*LogingResponse) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{3}
}

func (x *LogingResponse) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
const file_sso_sso_proto_rawDesc = "" +
	"\n" +
	"\rsso/sso.proto\x12\x04auth\x1a\x1bgoogle/protobuf/empty.proto\"C\n" +
	...
	"\bis_admin\x18\x01 \x01(\bR\aisAdmin2\xeb\x01\n" +
	"\x04Auth\x12;\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\"\x00\x123\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x14.auth.LogingResponse\"\x00\x127\n" +
	"\x06Logout\x12\x13.auth.LogoutRequest\x1a\x16.google.protobuf.Empty\"\x00\x128\n" +
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponse\"\x00B\x0eZ\fsso.v1;ssov1b\x06proto3"
...
var file_sso_sso_proto_goTypes = []any{
	...
	(*LogingResponse)(nil),   // 3: auth.LogingResponse
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	3, // 5: auth.Auth.Login:output_type -> auth.LogingResponse
	8, // 6: auth.Auth.Logout:output_type -> google.protobuf.Empty
